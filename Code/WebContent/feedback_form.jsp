...
<head>
    ...
    <title>Other Complaint Form</title>
    ...
    <style>
        ...
        body {
            ...
            margin: 0;
            padding: 0;
            background-image: url('images/rc.jpg'); /* Replace with your image path */
        ...
        .container {
            ...
            margin: 40px auto; /* Center horizontally with auto margins and add some top margin */
        }
...
<body>
            ...
            <nav class="navbar navbar-expand-md navbar-dark">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="My_Pending_Complaint.jsp">Pending Complaint</a></li>
                      <li class="nav-item active"><a class="nav-link" href="feedback_form.jsp">Add Feedback</a></li>
    ...
    <!-- Other Complaint Form Section -->
    <div class="container">
        <h2 class="form-header">Add Your Feedback</h2>
        <form  method="POST">
            ...
            <div class="form-group">
                <label for="feedback">Type Your Feedback:</label>
                <textarea class="form-control" id="feedback" name="feedback" rows="4" required></textarea>
            </div>
            <button type="submit" class="btn">Submit Feedback</button>
        </form>
    </div>
    <!-- end Other Complaint Form Section -->
...
if ("POST".equalsIgnoreCase(request.getMethod())) {
    ...
    try {
        ...
        String query = "INSERT INTO feedback_form(name, email,roll_number,feedback, register_id) VALUES (?, ?,?, ?, ?)";
