...
<head>
    ...
    <title>Faculty Complaint Form</title>
    ...
    <style>
        ...
        body {
            ...
            margin: 0;
            padding: 0;
            background-image: url('images/r.webp'); /* Replace with your image path */
...
<body>
    ...
    <!-- Faculty Complaint Form Section -->
    <div class="container">
        <h2 class="form-header">faculty Complaint Form</h2>
        <form method="POST">
            ...
            <option value="Late Grading">Late Grading</option>
            <option value="Late Grading">Bad Communication</option>
            <option value="Unprofessional Behavior">Unprofessional Behavior</option>
            <option value="Course Content Issues">Course Content Issues</option>
    ...
    <!-- end Library Complaint Form Section -->
