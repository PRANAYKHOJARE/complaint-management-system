...
<head>
    ...
    <title>Library Complaint Form</title>
    ...
    <style>
        ...
        body {
            ...
            margin: 0;
            padding: 0;
            background-image: url('images/library.jpg'); /* Replace with your image path */
...
<body>
        ...
        <div class="header">
            ...
            <nav class="navbar navbar-expand-md navbar-dark">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="My_Solved_Complaint.jsp">Solved Complaint</a></li>
    ...
    <!-- Library Complaint Form Section -->
    <div class="container">
        <h2 class="form-header">Library Complaint Form</h2>
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="issue_type" name="issue_type" required>
                    ...
                    <option value="staff_helpfulness">Staff Helpfulness</option>
