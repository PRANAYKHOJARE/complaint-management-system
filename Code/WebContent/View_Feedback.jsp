...
<head>
    ...
    <title>Kaiadmin - Feedback List</title>
            ...
            <div class="sidebar-content">
                <ul class="nav nav-secondary">
                    ...
                    <li class="nav-item ">
                      ...
                      <li class="nav-item active"><a href="View_Feedback.jsp"><i class="fas fa-comments"></i><p>View Students Feedback</p></a></li>
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="d-flex align-items-left flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-3">Feedback List</h3>
                            <h6 class="op-7 mb-2">List of User Feedback</h6>
                        </div>
                    </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            try {
                                                ...
                                                rs = stmt.executeQuery("SELECT * FROM feedback_form");
