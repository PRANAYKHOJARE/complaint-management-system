...
<head>
    ...
    <title>Kaiadmin - Pending Complaints</title>
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="d-flex align-items-left flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-3">Pending Complaints</h3>
                            <h6 class="op-7 mb-2">List of Complaints Marked as Pending</h6>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Pending Complaints List</h4>
                                </div>
                                <div class="card-body">
                                    <table class="table">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            try {
                                                ...
                                                rs = stmt.executeQuery("SELECT * FROM complaints WHERE action = 0");
